        ...
        <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
          ...
          <FadeIn delay={0.03} style={{ margin: '-1.5rem auto 2rem', maxWidth: '560px' }}>
            <div style={{ background: 'rgba(0,212,255,0.06)', border: `1px solid ${C.cyan}`, borderRadius: '14px', padding: '1.1rem 1.25rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '1rem', flexWrap: 'wrap' }}>
              ...
              <a href="/registro?plan=test" className="btn-primary" style={{ padding: '0.75rem 1.1rem', borderRadius: '10px', fontSize: '0.9rem', fontWeight: 800, textAlign: 'center', textDecoration: 'none', whiteSpace: 'nowrap' }}>Crear cuenta y probar</a>
            </div>
          </FadeIn>
              ...
              return (
                <FadeIn key={i} delay={i * 0.07}>
                  <div className="plan-card" style={{ background: C.bgCard, border: `1px solid ${highlight ? C.pink : C.border}`, borderTop: `2px solid ${highlight ? C.pink : i === 0 ? '#7c3aed' : C.cyan}`, borderRadius: '16px', padding: '2rem', display: 'flex', flexDirection: 'column', gap: '1.2rem', position: 'relative', boxShadow: highlight ? '0 0 48px rgba(224,64,251,0.08)' : 'none', height: '100%' }}>
                    ...
                    <a
                      href={`/registro?plan=${['starter', 'growth', 'scale'][idx] || 'starter'}`}
