      ...
      <div style={{ maxWidth: '860px', margin: '0 auto', padding: '4rem 2rem 6rem' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '2.5rem' }}>
          ...
          <Section title="4. Planes y facturación">
            ...
            <p><strong style={{ color: C.text }}>Límites de mensajes:</strong> Todos los planes tienen un límite mensual de mensajes según el plan contratado: Starter 1.500 mensajes/mes, Growth 5.000 mensajes/mes y Scale 20.000 mensajes/mes. Si superás el límite, te notificaremos antes de interrumpir el servicio.</p>
